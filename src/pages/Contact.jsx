    ...
    <div className="py-8">
      <div className="mb-8 text-center">
        ...
        <p className="text-lg text-dark-500 dark:text-dark-300 max-w-2xl mx-auto">
          Have questions or need a custom solution? Get in touch with our team.
        </p>
      </div>
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-1">
            <div className="bg-white dark:bg-dark-700 rounded-xl shadow-md overflow-hidden h-full">
              <div className="p-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start">
                    <div className="flex-shrink-0 h-10 w-10 rounded-full bg-primary-100 dark:bg-primary-900/20 flex items-center justify-center">
                      <FaPhone className="h-5 w-5 text-primary-600 dark:text-primary-400" />
                    </div>
                    <div className="ml-4">
                ...
                <div className="mt-8">
                  ...
                  <div className="flex space-x-4">
                    <a href="#" className="text-dark-400 hover:text-primary-600 dark:text-dark-300 dark:hover:text-primary-400">
                ...
                <form onSubmit={handleSubmit}>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full px-4 py-2 border border-gray-300 dark:border-dark-500 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 bg-white dark:bg-dark-600 text-dark-700 dark:text-white"
                      />
                    </div>
                  ...
                  <div>
                    <button
                      ...
                      className="w-full sm:w-auto px-6 py-3 bg-primary-600 hover:bg-primary-700 text-white font-medium rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200"
                    >
